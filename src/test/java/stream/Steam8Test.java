...
public class Steam8Test {
    ...
    public void shouldReturnFirstTwo() {
        ...
        assertThat(users, is(equalTo(asList(users.get(0), users.get(1)))));
    }
    ...
    public void shouldReturnDistinctAges() {
        List<User> users = User.getUsersWithAge(18, 20, 20, 21, 22, 22, 23, 24, 25, 26,29,30);
        List<Integer> distinctAges = Stream8.getDistinctAges(users);
        assertThat(distinctAges, is(equalTo(asList(18, 20, 21, 22, 23, 24, 25, 26,29,30))));
    }
